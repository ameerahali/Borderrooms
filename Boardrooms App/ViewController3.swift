...
class ViewController3: UIViewController {
    ...
    let products: [Product] = [
        Product(productName: "Creative Space", productImage: "image4", productDescription: "Floor 5" , buttonn : "image4" ,available: "Available"),
        Product(productName: "ldeation", productImage: "image1", productDescription: "Floor 3" ,buttonn : "image1" ,available: "unvailable"),
        Product(productName: "lnspiration", productImage: "image3", productDescription: "Floor 1" , buttonn : "image3" ,available: "unvailable")
        
        
    ]
    
//    let board : [Board] = [
//        Board(boardName: "Creative Space", boardImage: "image2",  boardFloor: "Floor 5" )
//
//    ]
...
extension ViewController3: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
